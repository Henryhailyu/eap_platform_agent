...
class EapConfig:
    ...
    TTS_VOICE_ID: str = (os.environ.get("EAP_TTS_VOICE_ID") or "101050").strip()
    # Tencent premium UK English: 101050 WeJack (male), 101051 WeRose (female)
    TTS_VOICE_MALE: str = (os.environ.get("EAP_TTS_VOICE_MALE") or "101050").strip()
    TTS_VOICE_FEMALE: str = (os.environ.get("EAP_TTS_VOICE_FEMALE") or "101051").strip()
    TTS_SAMPLE_RATE: int = int(os.environ.get("EAP_TTS_SAMPLE_RATE", "24000") or "24000")
    TTS_CODEC: str = (os.environ.get("EAP_TTS_CODEC") or "mp3").strip()
    TTS_SPEED: float = float(os.environ.get("EAP_TTS_SPEED", "0.92") or "0.92")
    TTS_VOLUME: float = float(os.environ.get("EAP_TTS_VOLUME", "1") or "1")

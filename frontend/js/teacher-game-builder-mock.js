...
(function (global) {
  ...
  const GAME_TEMPLATES = [
    ...
    { id: "treasure-hunt", nameEn: "Treasure Hunt", nameZh: "寻宝", type: "treasure_hunt", icon: "🗺" },
    { id: "escape-room", nameEn: "Escape Room", nameZh: "密室逃脱", type: "escape_room", icon: "🔐" },
    { id: "quiz-battle", nameEn: "Quiz Battle", nameZh: "问答对战", type: "placeholder", icon: "⚔" },
    { id: "word-ladder", nameEn: "Word Ladder", nameZh: "词汇阶梯", type: "word_ladder", icon: "📶" },
